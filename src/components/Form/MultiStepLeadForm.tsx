...
import StepIssueType from "./steps/StepIssueType";
    ...
    <FormProvider {...methods}>
      <div className="card p-6 sm:p-8 overflow-hidden border border-border/50" id="lead-form">
        ...
        {currentStep >= 2 && currentStep <= TOTAL_STEPS && (
          <div className="mb-6">
            <div className="flex justify-between text-xs mb-2" style={{ color: "#6B7D8E" }}>
              <span>Step {currentStep} of {TOTAL_STEPS}</span>
              <span>{Math.round(progressPercent)}% complete</span>
            </div>
            <div className="h-2 rounded-full overflow-hidden" style={{ background: "#F0E6D0" }}>
              <motion.div
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            {currentStep === 2 && (
              <motion.div
                ...
                transition={{ duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
              >
                <StepRole onNext={goNext} onBack={goBack} />
              </motion.div>
            )}
            ...
            {currentStep === 3 && (
              <motion.div
                ...
                transition={{ duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
              >
                <StepUrgency onNext={goNext} onBack={goBack} />
              </motion.div>
            )}
            ...
            {currentStep === 4 && (
              <motion.div
                ...
                transition={{ duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
              >
                <StepZipCode onNext={goNext} onBack={goBack} />
              </motion.div>
            )}
