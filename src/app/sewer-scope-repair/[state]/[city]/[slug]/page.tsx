/* ═══════════════════════════════════════════════════════════════════
 * /sewer-scope-repair/[state]/[city]/[slug]/page.tsx
 * Silo 4: Sewer Scope Repair — Dynamic Route
 * ═══════════════════════════════════════════════════════════════════ */
...
const SILO_KEY = "sewer-scope-repair" as const;
...
export default async function SewerScopeRepairPage({ params }: Props) {
  const { state, city, slug } = await params;
